...
\end{itemize}
$x = r\cos\varphi, \quad y = r\sin\varphi, \quad r = \sqrt{x^2 + y^2}, \quad
...
\begin{example2}{Darstellungsformen}{Umrechnung verschiedener Darstellungen}
Gegeben: $z = 3 - 11i$
\begin{enumerate}
    \item Berechnung von $r$: $r = \sqrt{3^2 + 11^2} = \sqrt{130}$
    \item Berechnung von $\varphi$: $\varphi = \arcsin\left(\frac{11}{\sqrt{130}}\right) = 1.3$
    \item Trigonometrische Form: $z = \sqrt{130}(\cos(1.3) + i\sin(1.3))$
    \item Exponentialform: $z = \sqrt{130}e^{i\cdot 1.3}$
\end{enumerate}
\end{example2}

\begin{example}{Umrechnungen}
Gegeben: $z = 3 - 4i$ in Normalform
\begin{enumerate}
   \item $r = \sqrt{3^2 + (-4)^2} = 5$
   \item $\varphi = \arctan(\frac{-4}{3}) + \pi = -0.927$ rad $= -53.13^{\circ} $
   \item Trigonometrische Form: $z = 5(\cos(-0.927) + i\sin(-0.927))$
   \item Exponentialform: $z = 5e^{-0.927i}$
\end{enumerate}
\end{example}
...
\begin{example2}{Eigenwertberechnung}{Matrix mit drei Eigenwerten}
Gegeben sei: $A = \begin{pmatrix} 1 & 0 & 0\\ 2 & 3 & 0\\ 0 & 1 & 2\end{pmatrix}$
