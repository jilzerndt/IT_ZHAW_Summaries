...
Die Software-Entwicklung erfolgt auf verschiedenen Ebenen, die eng miteinander verzahnt sind:
...
Die Architekturanalyse erfolgt iterativ mit den Anforderungen (Twin Peaks Model):
...
\textbf{Unterschiede:}
\begin{itemize}
    \item ISO 25010 ist ein formaler Standard
    \item FURPS+ ist ein pragmatisches Akronym
    \item ISO 25010 bietet detailliertere Metriken
    \item FURPS+ ist einfacher in der Anwendung
\end{itemize}
\end{theorem}
...
\begin{theorem}{Qualitätskriterien und deren Umsetzung}\\
