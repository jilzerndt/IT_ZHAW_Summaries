...
\subsection{JavaScript Objekte und Arrays}
...
\subsection{JavaScript Funktionen und funktionale Programmierung}

\subsection{JavaScript Prototypen von Objekten}

\subsection{JavaScript Asynchrone Programmierung}

\subsection{JavaScript Webserver}