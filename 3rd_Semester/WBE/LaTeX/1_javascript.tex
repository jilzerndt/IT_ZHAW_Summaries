...
\begin{definition}{Variablenbindung}
    ...
    \end{itemize}
    \includegraphics[width=\linewidth]{images/images/2024_12_29_858f09cde51177c71657g-05}
\end{definition}
...
\begin{code}{Arrays}
    ...
    \begin{itemize}
        ...
        \item .map(item => ...)
    \end{itemize}
    \includegraphics[width=\linewidth]{images/images/2024_12_29_858f09cde51177c71657g-08}
\end{code}
...
\includegraphics[width=\linewidth]{images/images/2024_12_29_858f09cde51177c71657g-14}
\end{itemize}
