...
C) If-Then-Else with signed 16-bit variables\\
\includegraphics[max width=\textwidth, center]{2025_01_02_7eee2d56b23c0199f878g-7(1)}
...
C & Assembly \\
\hline
\texttt{int16\_t varC = ...; if (varC == 2344 || varC > 6788)\{ varC = varC / 4; \} else \{ varC = varC / 2; \}} & \includegraphics[max width=\textwidth]{2025_01_02_7eee2d56b23c0199f878g-7}
 \\
\hline
\end{tabular}
\end{center}
...
C & Assembly \\
\hline
\texttt{\#include <utils\_ctboard.h> \#include <stdint.h> ... int32\_t = 0; int32\_t count = 0; for(i = 0; i < 10; i++) \{ count++; \}} & \includegraphics[max width=\textwidth]{2025_01_02_7eee2d56b23c0199f878g-8}
 \\
\hline
\end{tabular}
\end{center}
...
\includegraphics[max width=\textwidth, center]{2025_01_02_7eee2d56b23c0199f878g-8(1)}
