...
\begin{theorem}{Overview}
    ...
    \includegraphics[width=0.5\linewidth]{intro_overview.png}
\end{theorem}
...
\begin{concept}{Machine Learning - Types}
    ...
    \includegraphics[width=0.8\linewidth]{supervised_vs_unsupervised.png}
    ...
    \includegraphics[width=0.8\linewidth]{reinforcement_learning.png}
\end{concept}
...
\begin{definition}{Regression}
    ...
    \includegraphics[width=0.8\linewidth]{regression.png}
\end{definition}
