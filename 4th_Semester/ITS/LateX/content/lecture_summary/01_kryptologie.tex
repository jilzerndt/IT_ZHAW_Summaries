...
\includegraphics[width=\linewidth]{encryption_decryption.png}
\end{minipage}
...
\begin{definition}{Public Key Cryptography}
    ...
    \end{itemize}
    \includegraphics[angle=90,width=\linewidth]{public_key.png}
\end{definition}
...
\begin{concept}{Galois Counter Mode (GCM)}
    ...
    \end{itemize}
    \includegraphics[width=0.7\linewidth]{GCM.png}
\end{concept}
