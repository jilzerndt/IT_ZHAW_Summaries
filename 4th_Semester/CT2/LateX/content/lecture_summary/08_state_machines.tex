...
\includegraphics[width=\linewidth]{hardqwarevssoftwarefsm.png}
\end{concept}
...
\end{itemize}
\includegraphics[width=0.3\linewidth]{incontrasttomealynotation.png}
\end{concept}
...
\end{itemize}
\includegraphics[width=0.7\linewidth]{portlinkfsm.png}
\end{definition}

\begin{example2}{Reactive System Partitioned into two FSMs}\\
    Interaction of FSMs happens through event messages.\\
    \includegraphics[width=0.4\linewidth]{eihgdfhdklhfjdshgdh.png}\\
...
\subsection{Examples of Software State Machines}
...
\begin{example2}{Autowaschanlage State Machine}
    ...
    \textbf{State Diagram:}\\
    \includegraphics[width=0.8\linewidth]{waschanlage_state_diagram.png}
    \begin{itemize}
