...
\begin{definition}{ADC Conversion Modes}\\
    \includegraphics[width=\linewidth]{adcconversionmodes.png}
\end{definition}
...
\begin{concept}{ADC Timing}\\
    \includegraphics[width=0.8\linewidth]{adctiming.png}
\end{concept}

\important{Important Parameters like power consumption, conversion time, and sampling time are defined in the Reference Manual}
