...
\begin{concept}{RS232 - Interconnecting Equipment by Cable}
    ...
    \end{itemize}
    \includegraphics[width=0.8\linewidth]{uart_interconnection1.png}
\end{concept}
...
\begin{theorem}
    ...
    \end{itemize}
    \includegraphics[width=\linewidth]{uart_interconnection2.png}
\end{theorem}
...
\includegraphics[width=\linewidth]{i2c_bus.png}
...
\begin{concept}{I2C Timing} MSB first!\\
    \includegraphics[width=0.8\linewidth]{i2c_timing_slave_addressing.png}\\
