...
\begin{theorem}{Rechenregeln für Vektoren I}\\
    ...
    \begin{center}
        \includegraphics[width=0.8\linewidth]{vec-calc-regeln.png}
    \end{center}
\end{theorem}
...
\begin{definition}{Gegenvektor}
    \begin{wrapfigure}{r}{0.2\textwidth}
        \vspace{-10pt}
        \includegraphics[width=0.6\linewidth]{vec-gegen.png}
    \end{wrapfigure}
...
\begin{definition}{Kollinear}
    \begin{wrapfigure}{r}{0.2\textwidth}
        \vspace{-10pt}
        \includegraphics[width=0.6\linewidth]{vec-kollinear.png}
    \end{wrapfigure}
