...
\begin{example2}{Beispiel DEA (eindeutig)}
    ...
    \end{itemize}
    \includegraphics[width=0.5\linewidth]{images/images/dea_example.png}
...
\begin{definition}{Nichtdeterministischer endlicher Automat (NEA)}\\
    ...
    \includegraphics[width=0.2\linewidth]{images/images/ndea.png}
\end{definition}
...
\begin{example2}{NEA (nicht eindeutig)}
    ...
    \end{itemize}
    \includegraphics[width=0.5\linewidth]{images/images/nea_example1.png}
    \begin{itemize}
        \item Äquivalenter NEA
    \end{itemize}
    \includegraphics[width=0.5\linewidth]{images/images/äquivalenter_nea.png}
\end{example2}
...
\begin{formula}{Teilmengenkonstruktion}\\
    ...
    \end{enumerate}
    \includegraphics[width=0.5\linewidth]{images/images/teilmengenkonstruktion.png}\\
    \includegraphics[width=0.5\linewidth]{images/images/teilmengenkonstruktion2.png}
\end{formula}    