...
\begin{example2}{Beispiel DEA (eindeutig)} Sprache: $L(M)=\left\{1 x 1 \mid x \in\{0\}^{*}\right\}$
    ...
    \begin{minipage}{0.45\linewidth}
        \includegraphics[width=1\linewidth]{images/images/dea_example.png}
    \end{minipage}
    \hspace{1mm}
    \begin{minipage}{0.5\linewidth}
...
\begin{formula}{Teilmengenkonstruktion}
    ...
    \begin{minipage}{0.5\linewidth}
        \includegraphics[width=1\linewidth]{images/images/teilmengenkonstruktion.png}
    \end{minipage}
    \begin{minipage}{0.5\linewidth}
        \includegraphics[width=1\linewidth]{images/images/teilmengenkonstruktion2.png}
    \end{minipage}
\end{formula}   
...
\begin{example2}{NEA (nicht eindeutig)} Sprache: $L(M)=\left\{x 01 \mid x \in\{0,1\}^{*}\right\}$
    ...
    \begin{minipage}{0.5\linewidth}
        \includegraphics[width=1\linewidth]{images/images/nea_example1.png}
    \end{minipage}
    \hspace{1mm}
    \begin{minipage}{0.5\linewidth}
        \begin{center}
        \includegraphics[width=1\linewidth]{images/images/äquivalenter_nea.png}
