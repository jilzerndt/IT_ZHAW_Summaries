\section{Übertragungsmedien}
    ...
    \begin{centering}
    \includegraphics[width=0.8\linewidth]{images/images/Kategorisierung_übertragungsmedien.png}
    \end{centering}
    ...
    \begin{formula}{Signaldämpfung}\\
        ...
        \includegraphics[width=0.9\linewidth]{images/images/Signaldämpfung.png}\\
    ...
    \begin{definition}{Dämpfungsbelag}\\
        ...
        \begin{minipage}{0.6\linewidth}
            \begin{center}
            \includegraphics[width=0.9\linewidth]{images/images/Dämpfungsbelag_Kabel.png}
            \end{center}
        \end{minipage}
    \end{definition}
    ...
    \begin{definition}{Koaxialkabel}\\
        ...
        \begin{minipage}{0.3\linewidth}
            \includegraphics[width=1\linewidth]{images/images/Koaxkabel.png}
        \end{minipage}
    \end{definition}
    ...
    \begin{concept}{Lichtwellenleiter}\\
        ...
        \end{itemize}
            \begin{center}
                \includegraphics[width=1\linewidth]{images/images/Lichtwellenleiter.png}\\
            \end{center}
        \begin{itemize}
