...
\includegraphics[width=1\linewidth]{images/images/orientierung_network_layer.png}
...
\begin{definition}{Router} verbinden Subnetze (Ethernet, xDSL, WLAN, etc.)
    ...
    \end{itemize}
    \includegraphics[width=0.9\linewidth]{images/images/router2.png}
\end{definition}
...
\begin{example}
    \begin{center}
    \includegraphics[width=0.65\linewidth]{images/images/bsp_routing_tabelle.png}
    \end{center}
\end{example}
...
Was geschieht mit dem IP-Paket?
    ...
    \end{itemize}
        \includegraphics[width=1\linewidth]{images/images/flaches_routing_bsp.png}
\end{example2}
...
\begin{concept}{Hierarchisches Routing (Default)}
    ...
    \end{itemize}
        \includegraphics[width=1\linewidth]{images/images/hierarchisches_routing.png}
\end{concept}
...
\begin{definition}{Terminologie}
    ...
    \end{itemize}
    \includegraphics[width=1\linewidth]{images/images/ip_adressen_terminologie.png}
\end{definition}

\begin{concept}{Subnetzmaske}\\
    bestimmt die Grenze zwischen Netz- und Interface-Adressbits:\\
        \includegraphics[width=1\linewidth]{images/images/subnetzmaske.png}\\
    \includegraphics[width=1\linewidth]{images/images/subnetzmaske_bsp.png}   
\end{concept}

\begin{formula}{Netzmasken}\\
    \includegraphics[width=1\linewidth]{images/images/subnetzmaske_bsp_2.png}
\end{formula}
...
\begin{KR}{Rechnen mit Netzmasken}\\
    Typische Internet-Adressen Aufgabenstellung: Berechnen Sie die fehlenden Informationen\\
        \includegraphics[width=1\linewidth]{images/images/rechenne_mit_netzmasken.png}
\end{KR}
...
\begin{concept}{Classful Routing}\\
    ...
    \end{itemize}
        \includegraphics[width=1\linewidth]{images/images/classfulrouitng.png}
\end{concept}

\begin{example2}{Classful Routing}\\
    Beispiel von 4 zusammengeschlossenen Netzen:\\
        \includegraphics[width=1\linewidth]{images/images/classful_routing.png}
\end{example2}

\begin{KR}{Internet-Adressierung (IPv4 Netz-Klassen)}\\
    \includegraphics[width=0.9\linewidth]{images/images/ipv4.png}
\end{KR}
...
\begin{example}
    Beispiel: Zusammenfassen von 4 Class C Netzen (22 = 2 Bits der Subnetzmaske)\\
        \includegraphics[width=1\linewidth]{images/images/example_supernetting.png}
\end{example}
...
\begin{concept}{Subnetting}
    ...
    \end{itemize}
        \includegraphics[width=1\linewidth]{images/images/subnetting1.png}\\
    Damit haben wir 8 neue Subnetze mit den folgenden Netzadressen:\\
        \includegraphics[width=0.75\linewidth]{images/images/subnetting2.png}
    \begin{itemize}
...
\begin{example2}{Flexible Aufteilung eines Netzbereiches}\\
    Ein KMU mit 4 Standorten hat von seinem ISP das Netz 193.72.32.0 /21 erhalten. Das KMU hat 3 grössere und einen kleineren Standort und will diese redundant verbinden.\\
        \includegraphics[width=1\linewidth]{images/images/flexible_aufteilung_netzbereich.png}    
\end{example2}
...
\begin{KR}{IP-Header Format}
    ...
    \end{itemize}
        \includegraphics[width=1\linewidth]{images/images/internet_protokoll_format_ip.png}\\
...
\begin{formula}{Reassembly}
    ...
    \end{itemize}
        \includegraphics[width=0.75\linewidth]{images/images/reassembly.png}\\
...
\begin{definition}{Kapselung eines IP-Pakets im Ethernet Frame}\\
    ...
    \end{itemize}
        \includegraphics[width=1\linewidth]{images/images/kapselung_ip_paket.png}
\end{definition}
...
\begin{example2}{Übertragung eines IP-Pakets mit Encapsulation}\\
    \includegraphics[width=0.6\linewidth]{images/images/encapsulation_bsp.png}\\
...
\begin{concept}{ARP}
    ...
    \end{itemize}
        \includegraphics[width=1\linewidth]{images/images/arp_concept.png}
\end{concept}
...
\begin{formula}{ARP Nachrichtenstruktur}\\
    ...
    \end{itemize}
        \includegraphics[width=1\linewidth]{images/images/arp_nachrichtenstruktur.png}
\end{formula}
...
\begin{concept}{Internet Control Message Protocol (ICMP)}\\
    ...
    \end{itemize}
        \includegraphics[width=0.75\linewidth]{images/images/icmp.png}
\end{concept}
...
\begin{KR}{ICMP Format}\\
    ...
    \includegraphics[width=1\linewidth]{images/images/icmp_details.png}
\end{KR}
...
\begin{formula}{ICMP Meldungstypen}
    ...
    \end{itemize}
    \begin{center}
        \includegraphics[width=0.8\linewidth]{images/images/icmp_medlungstypen.png}
    \end{center}
    Codes:
    \begin{itemize}
...
\begin{definition}{ICMP Destination Unreachable}\\
    Vom Router/Zielhost an Absender gesendet, wenn Paket nicht weitergeleitet werden kann\\
        \includegraphics[width=1\linewidth]{images/images/destination_unreachable.png}\\
...
\begin{example}
        \includegraphics[width=0.75\linewidth]{images/images/dest_unreachable_ex1.png}\\
