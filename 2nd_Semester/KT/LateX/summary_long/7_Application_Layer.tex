...
\begin{definition}{DNS - Domain Name Space}
    ...
    \end{itemize}
    \includegraphics[width=1\linewidth]{images/images/dns_explained.png}
\end{definition}
...
\begin{definition}{DNS Record Types}\\
    ...
    \includegraphics[width=1\linewidth]{images/images/dns_record_types.png}
\end{definition}
...
\begin{example2}{DNS-Abfragen auswerten}
    ...
    \end{itemize}
        \includegraphics[width=1\linewidth]{images/images/example_dns.png}        
\end{example2}
...
\begin{definition}{DHCP - Dynamic Host Configuration Protocol}
    ...
    \end{itemize}
    \includegraphics[width=1\linewidth]{images/images/bootp.png}
\end{definition}
