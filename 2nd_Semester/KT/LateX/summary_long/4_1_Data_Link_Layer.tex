...
\begin{definition}{Framing (Rahmenbildung-/erkennung)}\\
    \includegraphics[width=0.6\linewidth]{images/images/frame_def.png}
    \begin{itemize}
...
\begin{concept}{Asynchron}\\
    ...
    \end{itemize}
    \includegraphics[width=0.7\linewidth]{images/images/asynchrone_übertragung_dll.png}
\end{concept}
...
\begin{concept}{Synchron}\\
    ...
    \end{itemize}
    \includegraphics[width=0.8\linewidth]{images/images/synchron_übertragung_dll.png}\\
    Frames werden durch ein Start-Flag und ein End-Flag begrenzt:\\
    \includegraphics[width=0.6\linewidth]{images/images/flags_frames.png}\\
...
\begin{concept}{Bitstopfen}\\
    ...
    \end{itemize}
        \includegraphics[width=0.7\linewidth]{images/images/bit_stuffing.png}
\end{concept}
...
\begin{concept}{Fehlererkennung}\\
    ...
    \includegraphics[width=0.5\linewidth]{images/images/fehlererkennung.png}\\
...
\begin{concept}{Hammingdistanz als Mass für Fehlerdetektion}\\
    Codes mit Hamming-Distanz $\leqq$ 2 erlauben die Erkennung von Ein- oder Mehr-Bitfehlern \\
        \includegraphics[width=0.8\linewidth]{images/images/hamming_distanz.png}\\
...
\begin{concept}{Fehlererkennung mit einfacher Parity}\\
    Ein (1) Prüfbit sichert ein Datenwort (typisch 1 Byte, auch 7 oder 9 Bits werden verwendet)\\
        \includegraphics[width=0.8\linewidth]{images/images/einfache_parity.png}
\begin{itemize}
...
\begin{concept}{Längs- und Quer-Parity}\\
        \includegraphics[width=0.6\linewidth]{images/images/längs-quer-parity.png}\\
...
\begin{definition}{Master-Slave Verfahren}\\
    Verwenden mehrere Systeme das gleiche physikalische Medium, so muss der Zugriff auf das Medium koordiniert werden\\
        \includegraphics[width=0.75\linewidth]{images/images/master-slave.png}
    \begin{itemize}
...
\begin{definition}{Token Verfahren}\\
    Die Sendeberechtigung wird in einer festgelegten Reihenfolge weitergereicht: Knoten senden nur, wenn sie ein Token halten\\
        \includegraphics[width=0.75\linewidth]{images/images/token-verfahren.png}
    \begin{itemize}
...
\begin{concept}{Kombi Master-Slave und Token}\\
    ...
    \end{itemize}
        \includegraphics[width=0.75\linewidth]{images/images/combo_master_slave_token.png}
\end{concept}
...
\begin{definition}{Carrier Sense Multiple Access}
    ...
    \end{itemize}
        \includegraphics[width=0.75\linewidth]{images/images/random_access_thingy.png}\\
...
\begin{concept}{Kollisionsbehandlung}\\
    ...
    \begin{itemize}
        ...
        \end{itemize}
    \end{itemize}
        \includegraphics[width=0.75\linewidth]{images/images/kollisionsbehandlung.png}
\end{concept}
...
\begin{definition}{Explizite Start-Stop Signalisierung}
    \begin{itemize}
        ...
        \end{itemize}
    \end{itemize}
        \includegraphics[width=0.5\linewidth]{images/images/flow_control1.png}
\end{definition}
...
\begin{definition}{Implizit mit Stop and Wait Protokoll}\\
    ...
    \end{itemize}
        \includegraphics[width=0.5\linewidth]{images/images/flow_control2.png}
\end{definition}
