...
\begin{concept}{Taktrückgewinnung}
    \center
    \includegraphics[width=0.8\linewidth]{images/images/taktrückgewinnung.png}
    \center
    \includegraphics[width=0.8\linewidth]{images/images/taktrückgewinnung1.png}
\end{concept}
...
\begin{concept}{AMI Leitungscode} Alternate Mark Inversion (3-wertig)\\
    \includegraphics[width=0.7\linewidth]{images/images/gleichspannungsfreiheit.png}\\
...
\begin{concept}{NRZI MLT-3 Leitungscodierung} \textcolor{pink}{100BASE-TX}
    ...
    \begin{minipage}{0.4\linewidth}
        \includegraphics[width=1\linewidth]{images/images/leitungscodierung.png}
    \end{minipage}
