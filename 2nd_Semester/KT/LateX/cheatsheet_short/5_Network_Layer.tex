...
\begin{definition}{Die Netzwerkschicht}\\
    Verbindet Hosts in verschiedenen Netzen und ermöglicht den
    Transport der IP-Pakete $\rightarrow$ NUR Transport \\
    höhere Layer übernehmen: Fehlerkorrektur, Flusskontrolle, etc.
\end{definition}
