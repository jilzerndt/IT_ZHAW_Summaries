...
\begin{KR}{IP-Header Format}
    ...
    \begin{itemize}
        ...
        \item \textcolor{blue}{IHL} Header Length in 4-Byte (20 Byte → IHL = 5 (Minimum))
        ...
        \item \textcolor{darkfrog}{Time to Live} anz. Sek, Hop-Counter (bei jeder Station -1) \\wenn 0 → Paket wird verworfen
    ...
    \end{itemize}
        \includegraphics[width=1\linewidth, height=0.35\linewidth]{images/images/internet_protokoll_format_ip.png}\\
...
\begin{formula}{Netzmasken} bestimmen Anzahl adressierbarer Interfaces im Netz\\
...
\begin{example}
    Zusammenfassen von 4 Class C Netzen (22 = 2 Bits der Subnetzmaske)\\
        \includegraphics[width=0.95\linewidth]{images/images/example_supernetting.png}
\end{example}
...
\begin{concept}{Subnetting}
    ...
    \end{itemize}
        \includegraphics[width=0.9\linewidth]{images/images/subnetting1.png}\\
    Damit haben wir 8 neue Subnetze mit den folgenden Netzadressen:\\
        \includegraphics[width=0.7\linewidth]{images/images/subnetting2.png}
    \begin{itemize}
