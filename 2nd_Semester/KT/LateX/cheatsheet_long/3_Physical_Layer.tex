...
\centering
    \includegraphics[width=0.8\linewidth]{images/images/max_bitrate_actual.png}
...
\begin{definition}{Synchrone Übertragung ohne separate Taktleitung}\\
    ...
    \includegraphics[width=1\linewidth]{images/images/synchrone_übertragung_ohne_seperate_Taktleitung.png}\\
...
\begin{concept}{Taktrückgewinnung}\\
    \includegraphics[width=1\linewidth]{images/images/taktrückgewinnung.png}\\
    \includegraphics[width=1\linewidth]{images/images/taktrückgewinnung1.png}
\end{concept}
