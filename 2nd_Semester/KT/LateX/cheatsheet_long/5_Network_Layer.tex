...
\begin{concept}{Classful Routing}\\
    ...
    \end{itemize}
        \includegraphics[width=0.9\linewidth]{images/images/classfulrouitng.png}
\end{concept}

\begin{KR}{Internet-Adressierung (IPv4 Netz-Klassen)}\\
    \includegraphics[width=0.8\linewidth]{images/images/ipv4.png}
\end{KR}
...
\begin{example}
    \includegraphics[width=1\linewidth]{images/images/encapsulation_bsp.png}\\
    \begin{itemize}
