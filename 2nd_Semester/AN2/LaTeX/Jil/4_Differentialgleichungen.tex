...
\begin{definition}{Richtungsfeld} geometrisches Verständnis von expliziten DGL 1. Ordnung, d.h. DGL der Form:
  ...
  \begin{minipage}{0.45\linewidth}
    \begin{center}
    \includegraphics[width=0.8\linewidth]{images/images/Richtungsfeld.png}
    \end{center}
  \end{minipage}
  \hspace{3mm}
  \begin{minipage}{0.45\linewidth}
    \begin{center}
    \includegraphics[width=0.8\linewidth]{images/images/RichtungsfeldKurve.png}
    \end{center}
  \end{minipage}
...
\begin{definition}{Richtungsfelder von Speziellen DGL}\\
  ...
  \begin{minipage}{0.4\linewidth}
    \begin{center}
      \includegraphics[width=1\linewidth]{images/images/UnbestimmtesIntegral.png}
      \end{center}
  \end{minipage}
  \begin{minipage}{0.58\linewidth}
  ...
  \begin{minipage}{0.4\linewidth}
    \begin{center}
      \includegraphics[width=1\linewidth]{images/images/AutonomeDGL.png}
      \end{center}
  \end{minipage}
\end{definition}
...
\begin{definition}{Eulerverfahren}
  Gleichung einer beliebigen Geraden mit Steigung \(m\) am Punkt \((x_k,y_k)\):
    ...
    \begin{minipage}{0.45\linewidth}
      \begin{center}
        \includegraphics[width=0.7\linewidth]{images/images/Newtonverfahren.png}
        \end{center}
    \end{minipage}
  \begin{itemize}
