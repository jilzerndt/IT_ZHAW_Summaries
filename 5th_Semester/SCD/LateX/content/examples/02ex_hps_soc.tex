...
\section{KR and Exercises: HPS and SoC}

\subsection{System on Chip Custom Peripheral}

\begin{example2}{Custom Peripheral Development}

\textbf{Question:} Which step comes first when adding a custom peripheral to the FPGA fabric for HPS access?

Wählen Sie eine Antwort:
\begin{itemize}
    \item Configuring the HPS in Platform Designer \textbf{\textcolor{red}{X}}
    \item Programming the device with Quartus
    \item Writing a Linux device driver
    \item Designing the peripheral in VHDL or Verilog \textcolor{frog}{$\surd$}
\end{itemize}
...
\important{Problem type:} Development workflow - Understanding the correct sequence for custom peripheral integration

\textbf{Source:} Moodle Quiz HPS and SoC, Question 1
\end{example2}

\subsection{System on Chip Software Execution}

\begin{example2}{SoC Component Responsibility}

\textbf{Question:} In a SoC FPGA, which component is responsible for running operating systems and complex software applications?

Wählen Sie eine Antwort:
\begin{itemize}
    \item Hard processor system (HPS) \textcolor{frog}{$\surd$}
    \item FPGA fabric \textbf{\textcolor{red}{X}}
    \item DMA controller \textbf{\textcolor{red}{X}}
    \item Bus bridge \textbf{\textcolor{red}{X}}
\end{itemize}
...
\important{Problem type:} Architecture - Understanding SoC FPGA component roles

\textbf{Source:} Moodle Quiz HPS and SoC, Question 2
\end{example2}

\subsection{System on Chip Advantages}

\begin{example2}{HPS Performance Benefits}

\textbf{Question:} What is the main advantage of using a hard processor system (HPS) in an SoC FPGA?

Wählen Sie eine Antwort:
\begin{itemize}
    \item It allows for reconfiguration of the processor at runtime \textbf{\textcolor{red}{X}}
    \item It enables direct analog signal processing \textbf{\textcolor{red}{X}}
    \item It eliminates the need for any memory controllers \textbf{\textcolor{red}{X}}
    \item It provides higher performance and lower power consumption compared to softcore processors \textcolor{frog}{$\surd$}
\end{itemize}
...
\important{Problem type:} Architecture - Understanding HPS advantages over softcore processors

\textbf{Source:} Moodle Quiz HPS and SoC, Question 3
\end{example2}

\subsection{System on Chip Architecture}

\begin{example2}{SoC FPGA Definition}

\textbf{Question:} Which of the following best describes a System-on-Chip (SoC) FPGA architecture?

Wählen Sie eine Antwort:
\begin{itemize}
    \item Multiple CPUs with no programmable logic \textbf{\textcolor{red}{X}}
    \item An FPGA with only softcore processors \textbf{\textcolor{red}{X}}
    \item A CPU and FPGA fabric integrated on a single chip \textcolor{frog}{$\surd$}
    \item A CPU and FPGA on separate chips connected by a PCB \textbf{\textcolor{red}{X}}
\end{itemize}
...
\important{Problem type:} Definition - Understanding SoC FPGA architecture

\textbf{Source:} Moodle Quiz HPS and SoC, Question 4
\end{example2}
