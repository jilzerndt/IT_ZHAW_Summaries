...
% Description: LVDS driver and receiver circuit diagram showing Driver with current source (~3.5mA) and LVDS-001 specification, transmission line, and Receiver with differential amplifier showing ~350mV voltage swing and 100\Omega$ termination resistor
...
\begin{itemize}
    \item Fixed 3.5 mA current through $100\Omega$ termination
...
\begin{enumerate}
    ...
    \item \textbf{Termination:} $100\Omega$ resistor at receiver end
    \item \textbf{Voltage developed:} $V = I \times R = 3.5\text{mA} \times 100\Omega = 350\text{mV}$
...
% Description: Same LVDS circuit diagram as previous with Driver, transmission lines, and Receiver showing 100\Omega$ termination and LVDS-001 specification
...
\begin{enumerate}
    ...
    \item Voltage developed across termination: $V = I \times R = 3.5\text{mA} \times 100\Omega = 350\text{mV}$
...
\section{KR and Exercises: I/O Interfaces}

\subsection{Signaling Standards}

\begin{example2}{LVDS Advantages}

\textbf{Question:} What are the Advantages of the Low Voltage Differential (LVDS) Standard

%\includegraphics[width=0.8\linewidth]{ex_io_lvds_circuit.png}

Wählen Sie eine oder mehrere Antworten:
\begin{itemize}
    \item Higher data transmission rates since there are only small voltage swings required \textcolor{frog}{$\surd$}
    \item Robust against shortcircuits since transmitter is current limited \textcolor{frog}{$\surd$}
    \item Low power consumption since transmitter limits maximum current \textcolor{frog}{$\surd$}
    \item Available also as single ended standard \textbf{\textcolor{red}{X}}
    \item Fault-tolerant in case one line is interrupted, since there are two lines per signal \textbf{\textcolor{red}{X}}
    \item Can not be used for clock lines \textbf{\textcolor{red}{X}}
    \item Lower cost compared to single ended signaling \textbf{\textcolor{red}{X}}
    \item High noise immunity due to compensation on differential lines \textcolor{frog}{$\surd$}
\end{itemize}
...
\important{Problem type:} Understanding LVDS signaling advantages

\textbf{Source:} Moodle Quiz I/O Interfaces, Question 1
\end{example2}

\begin{example2}{LVDS Fault Behavior}

\textbf{Question:} What happens at LVDS connections with regard to signal transmission if one of the two differential traces is interrupted?

%\includegraphics[width=0.8\linewidth]{ex_io_lvds_circuit.png}

Wählen Sie eine oder mehrere Antworten:
\begin{itemize}
    \item Information is transmitted, but with a lower data rate \textbf{\textcolor{red}{X}}
    \item Signals are transmitted with the inverted polarity \textbf{\textcolor{red}{X}}
    \item There is no current flow, such the receiver can not detect logical zero or one \textcolor{frog}{$\surd$}
    \item No voltage is induced on the termination resistor \textcolor{frog}{$\surd$}
    \item Information is still transmitted because the two lines are redundant \textbf{\textcolor{red}{X}}
    \item No Information is transmitted \textcolor{frog}{$\surd$}
\end{itemize}
...
\important{Problem type:} Understanding LVDS fault behavior when a line is interrupted

\textbf{Source:} Moodle Quiz I/O Interfaces, Question 2
\end{example2}
