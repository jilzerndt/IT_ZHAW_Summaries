...
% Priority: CRITICAL
% Suggested filename: exercise04_sdram_architecture.png
\\
% \includegraphics[width=\linewidth]{exercise04_sdram_architecture.png}
\\
...
% Priority: CRITICAL
% Suggested filename: exercise04_sdram_burst_timing.png
\\
% \includegraphics[width=\linewidth]{exercise04_sdram_burst_timing.png}
\\
% WHEN YOU ADD IMAGE: Uncomment line above (remove \%)
...
% Priority: CRITICAL
% Suggested filename: exercise04_sdram_timing_params.png
\\
% \includegraphics[width=0.9\linewidth]{exercise04_sdram_timing_params.png}
\\
% WHEN YOU ADD IMAGE: Uncomment line above (remove \%)
