...
\section{KR and Exercises: JTAG}

\subsection{JTAG Boundary Scan Cell}

\begin{example2}{Boundary Scan Cell Components}

\textbf{Question:} The above schematic shows a boundary scan cell for a bidirectional input/output pin of an FPGA. For each labelled part for the schematic, choose the matching description.

%\includegraphics[width=\linewidth]{ex_jtag_boundary_scan_cell.png}

\textbf{A:} \underline{\hspace{6cm}}

\textbf{D:} \underline{\hspace{6cm}}

\textbf{F:} \underline{\hspace{6cm}}

\textbf{G:} \underline{\hspace{6cm}}

\textbf{E:} \underline{\hspace{6cm}}

\textbf{B:} \underline{\hspace{6cm}}

\textbf{C:} \underline{\hspace{6cm}}
...
\important{Problem type:} Understanding JTAG boundary scan cell architecture

\textbf{Source:} Moodle Quiz JTAG, Question 1
\end{example2}

\subsection{JTAG Test Modes}

\begin{example2}{JTAG Testing Types}

\textbf{Question:} Choose the matching test mode for each description about JTAG testing.

\textbf{1.} The test program tests the component without being aware of its function: \underline{\hspace{4cm}}

\textbf{2.} Memory structures are tested with hardware dedicated for testing in the IC: \underline{\hspace{4cm}}

\textbf{3.} Testing the connections of components on a printed circuit board: \underline{\hspace{4cm}}

\textbf{4.} The component is tested for its behavior in normal operation: \underline{\hspace{4cm}}
...
\important{Problem type:} Understanding different JTAG testing methodologies

\textbf{Source:} Moodle Quiz JTAG, Question 2
\end{example2}

\subsection{JTAG Infrastructure}

\begin{example2}{JTAG Component Functions}

\textbf{Question:} Disclaimer: This exercise covers material we did not discuss in detail in the lecture. A potential problem in the exam will not be as detailed as this exercise.

Describe the Components of the JTAG infrastructure

%\includegraphics[width=0.9\linewidth]{ex_jtag_infrastructure.png}

\textbf{1.} Which JTAG Signal advances the states in the JTAG controller state machine: \underline{\hspace{3cm}}

\textbf{2.} What TAP controller signal will set the \textbf{Device ID Register} to allow its contents to be readout via the scan chain?: \underline{\hspace{3cm}}

\textbf{3.} Which JTAG signal controls the branching of the states in the JTAG controller state machine: \underline{\hspace{3cm}}

\textbf{4.} With which JTAG signal, IC test equipment receives the contents of the scan chains: \underline{\hspace{3cm}}

\textbf{5.} Which JTAG Register transfers data directly from TDI to TDO: \underline{\hspace{3cm}}

\textbf{6.} Which JTAG register controls and checks the IC self tests: \underline{\hspace{3cm}}

\textbf{7.} Which JTAG Register determines which scan chain is currently active: \underline{\hspace{3cm}}

\textbf{8.} Which JTAG signal disables the entire JTAG infrastructure: \underline{\hspace{3cm}}
...
\important{Problem type:} Understanding JTAG architecture and signal functions

\textbf{Source:} Moodle Quiz JTAG, Question 3
\end{example2}

\subsection{JTAG Operation Sequence}

\begin{example2}{JTAG Timing Sequence}

\textbf{Question:} Match the descriptions to the numbered phases in the JTAG timing diagram:

%\includegraphics[width=\linewidth]{ex_jtag_sequence.png}

\textbf{Pin input signals are captured:} \underline{\hspace{2cm}}

\textbf{Use instruction code to select which scan chain is to be used:} \underline{\hspace{2cm}}

\textbf{Captured data are shifted out:} \underline{\hspace{2cm}}

\textbf{Return to idle state:} \underline{\hspace{2cm}}
...
\important{Problem type:} Understanding JTAG operational sequence

\textbf{Source:} Moodle Quiz JTAG, Question 4
\end{example2}
