...
% Priority: CRITICAL
% Suggested filename: exercise07a_launch_latch_circuit.png
\\
% \includegraphics[width=0.8\linewidth]{exercise07a_launch_latch_circuit.png}
\\
...
% Priority: CRITICAL
% Suggested filename: exercise07a_cdc_timing.png
\\
% \includegraphics[width=0.9\linewidth]{exercise07a_cdc_timing.png}
\\
% WHEN YOU ADD IMAGE: Uncomment line above (remove \%)
...
% Priority: CRITICAL
% Suggested filename: exercise07a_setup_timing.png
\\
% \includegraphics[width=0.9\linewidth]{exercise07a_setup_timing.png}
\\
% WHEN YOU ADD IMAGE: Uncomment line above (remove \%)
...
% Priority: CRITICAL
% Suggested filename: exercise07a_hold_timing.png
\\
% \includegraphics[width=0.9\linewidth]{exercise07a_hold_timing.png}
\\
% WHEN YOU ADD IMAGE: Uncomment line above (remove \%)
...
% Priority: CRITICAL  
% Suggested filename: exercise07b_timing_analysis_1.png
\\
% \includegraphics[width=\linewidth]{exercise07b_timing_analysis_1.png}
\\
% WHEN YOU ADD IMAGE: Uncomment line above (remove \%)
...
% Priority: CRITICAL
% Suggested filename: exercise07b_timing_analysis_2.png
\\
% \includegraphics[width=\linewidth]{exercise07b_timing_analysis_2.png}
\\
% WHEN YOU ADD IMAGE: Uncomment line above (remove \%)
