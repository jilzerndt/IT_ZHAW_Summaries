...
\begin{itemize}
    ...
    \begin{itemize}
        \item Resistance value (e.g., $50\Omega$, $100\Omega$, $120\Omega$)
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Weak pull-up: $10k\Omega$ - $100k\Omega$ (internal FPGA pull-ups)
        \item Strong pull-up: $1k\Omega$ - $10k\Omega$ (bus applications, often external)
    \end{itemize}
...
\begin{itemize}
    \item \textbf{LVDS:} Requires differential termination ($100\Omega$ typical)
...
\section{KR and Exercises: GPIO Components}

\subsection{GPIO Circuit Components}

\begin{example2}{GPIO Driver Types}

\textbf{Question:} Label the following GPIO driver circuit:

%\includegraphics[width=\linewidth]{ex_gpio_driver_1.png}
...
\important{Problem type:} Circuit analysis - GPIO driver components

\textbf{Source:} Moodle Quiz GPIO Components, Question 1
\end{example2}

\begin{example2}{GPIO Input Buffer}

\textbf{Question:} Label the following GPIO input buffer circuit:

%\includegraphics[width=\linewidth]{ex_gpio_input_buffer.png}
...
\important{Problem type:} Circuit analysis - GPIO input buffer

\textbf{Source:} Moodle Quiz GPIO Components, Question 2
\end{example2}

\begin{example2}{GPIO Termination}

\textbf{Question:} Label the GPIO termination circuit:

%\includegraphics[width=\linewidth]{ex_gpio_termination.png}
...
\important{Problem type:} Circuit analysis - GPIO termination

\textbf{Source:} Moodle Quiz GPIO Components, Question 3
\end{example2}

\begin{example2}{Pull-up and Pull-down Resistors}

\textbf{Question:} Label the pull-up/pull-down resistor circuit:

%\includegraphics[width=\linewidth]{ex_gpio_pullup_pulldown.png}
...
\important{Problem type:} Circuit analysis - Pull resistors

\textbf{Source:} Moodle Quiz GPIO Components, Question 4
\end{example2}

\begin{example2}{Bus Hold Circuit}

\textbf{Question:} Label the bus-hold circuit:

%\includegraphics[width=\linewidth]{ex_gpio_bus_hold.png}
...
\important{Problem type:} Circuit analysis - Bus-hold circuits

\textbf{Source:} Moodle Quiz GPIO Components, Question 5
\end{example2}

\raggedcolumns
\columnbreak

\section{KR and Exercises: GPIO Programming}

\subsection{Linux GPIO Interface}

\begin{example2}{GPIO Sysfs Commands}

\textbf{Question:} Which commands are used to access GPIO pins through the Linux sysfs interface?

Fill in the blanks with the appropriate commands:

To export GPIO pin 10: \texttt{echo 10 > /sys/class/gpio/\_\_\_\_\_\_\_\_}

To set GPIO pin 10 as output: \texttt{echo out > /sys/class/gpio/gpio10/\_\_\_\_\_\_\_\_}

To set GPIO pin 10 high: \texttt{echo 1 > /sys/class/gpio/gpio10/\_\_\_\_\_\_\_\_}
...
To export GPIO pin 10: \texttt{echo 10 > /sys/class/gpio/export}

To set GPIO pin 10 as output: \texttt{echo out > /sys/class/gpio/gpio10/direction}

To set GPIO pin 10 high: \texttt{echo 1 > /sys/class/gpio/gpio10/value}

\important{Problem type:} Linux GPIO sysfs interface commands

\textbf{Source:} Moodle Quiz GPIO, Question 1
\end{example2}

\begin{example2}{Device Tree GPIO Configuration}

\textbf{Question:} In the device tree, how do you specify which GPIO pins are available to the system?

Wählen Sie eine Antwort:
\begin{itemize}
    \item By defining them in the bootloader configuration \textbf{\textcolor{red}{X}}
    \item By adding gpio-controller nodes in the device tree \textcolor{frog}{$\surd$}
    \item By modifying the FPGA bitstream \textbf{\textcolor{red}{X}}
    \item By editing /etc/gpio.conf \textbf{\textcolor{red}{X}}
\end{itemize}
...
\important{Problem type:} Understanding device tree GPIO configuration

\textbf{Source:} Moodle Quiz GPIO, Question 2
\end{example2}

\begin{example2}{Quartus GPIO Assignment}

\textbf{Question:} When configuring GPIO pins in Quartus, which settings must be specified?

Wählen Sie eine oder mehrere Antworten:
\begin{itemize}
    \item Pin location \textcolor{frog}{$\surd$}
    \item I/O standard \textcolor{frog}{$\surd$}
    \item Current strength \textcolor{frog}{$\surd$}
    \item Clock frequency \textbf{\textcolor{red}{X}}
\end{itemize}
...
\important{Problem type:} Quartus GPIO pin assignment configuration

\textbf{Source:} Moodle Quiz GPIO, Question 3
\end{example2}

\begin{example2}{GPIO Driver Implementation}

\textbf{Question:} What are the key components of a basic GPIO driver in Linux?

Wählen Sie eine oder mehrere Antworten:
\begin{itemize}
    \item Initialization function \textcolor{frog}{$\surd$}
    \item Read/Write functions \textcolor{frog}{$\surd$}
    \item Interrupt handler (if interrupts are supported) \textcolor{frog}{$\surd$}
    \item DMA controller \textbf{\textcolor{red}{X}}
\end{itemize}
...
\important{Problem type:} Understanding Linux GPIO driver components

\textbf{Source:} Moodle Quiz GPIO, Question 4
\end{example2}

\begin{example2}{GPIO Pin Multiplexing}

\textbf{Question:} In SoC FPGAs, GPIO pins can often be multiplexed with other functions. What does this mean?

Wählen Sie eine Antwort:
\begin{itemize}
    \item The same physical pin can be configured for different purposes \textcolor{frog}{$\surd$}
    \item Multiple GPIO pins share the same driver \textbf{\textcolor{red}{X}}
    \item GPIO pins can only be used for input or output, not both \textbf{\textcolor{red}{X}}
    \item GPIO pins require external multiplexer chips \textbf{\textcolor{red}{X}}
\end{itemize}
...
\important{Problem type:} Understanding GPIO pin multiplexing

\textbf{Source:} Moodle Quiz GPIO, Question 5
\end{example2}
