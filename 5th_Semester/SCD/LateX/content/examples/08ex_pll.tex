...
% Priority: CRITICAL
% Suggested filename: exercise08_pll_diagram.png
\\
% \includegraphics[width=\linewidth]{exercise08_pll_diagram.png}
\\
...
\begin{itemize}
    ...
    \item Fpll period ≈ 10/6 ns (actually counting from diagram)
