...
\begin{concept}{Understanding Code-Hardware Interactions}\\
...
\begin{definition}{Definition vs Declaration}\\
\textbf{Definition:}
\begin{itemize}
...
\begin{itemize}
    ...
    \item Uses \texttt{extern} to specify object is defined elsewhere
\end{itemize}
\end{definition}

\begin{examplecode}{Definition vs Declaration}
\begin{lstlisting}[language=C, style=base]
...
\textbf{Key principle:} Interface $\rightarrow$ header file
\end{concept}
...
\textbf{Key principle:} Implementation $\rightarrow$ .c file
\end{concept}
...
\begin{examplecode}{Module Interface Example}\\
...
\begin{example2}{Memory Allocation by Section} Solution
\begin{itemize}
